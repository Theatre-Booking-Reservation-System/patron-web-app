...
export const PRODUCTIONS: Production[] = [
  ...
  },
  {
    ...
    reviews: 88,
    synopsis:
      'A vibrant cultural celebration of nine nights of dance and devotion, brought to life with colour, rhythm and tradition.',
    image: 'assets/curtain.png',
    earlyAccess: true,
  },
  {
    ...
    basePrice: 1250,
    durationLabel: 'Approx. 1 hour 50 minutes',
    ageLabel: 'Suitable for all ages',
    venue: 'Main Theatre, Sapumal Theatre',
    rating: 4.7,
    reviews: 64,
    synopsis:
      'An enchanting evening of classical and contemporary dance, where every movement tells a timeless story.',
    image: 'assets/bg1.jpeg',
    earlyAccess: true,
  },
  {
    ...
    basePrice: 1350,
    durationLabel: 'Approx. 2 hours 20 minutes (with interval)',
    ageLabel: 'Suitable for ages 12+',
    venue: 'Main Theatre, Sapumal Theatre',
    rating: 4.5,
    reviews: 47,
    synopsis:
      'An epic tale of a king and his warrior, of loyalty and sacrifice, played out against the sweep of history.',
    image: 'assets/loginBg.png',
    earlyAccess: true,
  },
];
